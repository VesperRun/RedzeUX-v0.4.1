# Terms of Service - Redze UX

Effective date: 2026-05-27

## 1. Acceptance

By installing or using Redze UX, you agree to these terms.

## 2. Service Description

Redze UX provides local UI observation, heuristic insights, and advisory AI-assisted suggestions for websites and web applications.

## 3. No Guarantees

Redze UX suggestions are informational and advisory only. They are not guaranteed business outcomes, legal advice, or professional UX certification.
...
- Using the extension in compliance with applicable laws and platform terms
- Verifying insights with your own product research process

## 5. Prohibited Use

You may not use Redze UX to:

- attempt credential harvesting
- conduct unauthorized surveillance
- violate privacy rights or platform rules

## 6. AI Limitations

AI-assisted output may be imperfect, incomplete, or uncertain. The extension is designed to acknowledge uncertainty and avoid unsupported certainty claims.

## 7. Third-Party Services

If you enable a remote AI endpoint, you are responsible for that provider choice and any associated terms.
...
Current operator defaults are documented in **`PRICING.md`** and **`billing-config.js`**.
